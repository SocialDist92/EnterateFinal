 ...
 */
public class FragmentGym extends Fragment implements SortListener, PromotionsLoadedListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        subcategories.add(new Subcategory(R.mipmap.ic_lift, "Pesas"));
        subcategories.add(new Subcategory(R.mipmap.ic_women, "Mujeres"));
